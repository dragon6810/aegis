...
typedef enum
{
	STUDIO_FLAGS_X =	 0x0001,
	STUDIO_FLAGS_Y =	 0x0002,
	STUDIO_FLAGS_Z =	 0x0004,
	STUDIO_FLAGS_XR =	 0x0008,
	STUDIO_FLAGS_YR =	 0x0010,
	STUDIO_FLAGS_ZR =	 0x0020,
	STUDIO_FLAGS_LX =	 0x0040,
	STUDIO_FLAGS_LY =	 0x0080,
	STUDIO_FLAGS_LZ =	 0x0100,
	STUDIO_FLAGS_AX =	 0x0200,
	STUDIO_FLAGS_AY =	 0x0400,
	STUDIO_FLAGS_AZ =	 0x0800,
	STUDIO_FLAGS_AXR =   0x1000,
	STUDIO_FLAGS_AYR =   0x2000,
	STUDIO_FLAGS_AZR =   0x4000,

	STUDIO_FLAGS_TYPES = 0x7FFF,
	STUDIO_FLAGS_RLOOP = 0x8000,
} mstudiomotionflags_t;

#define STUDIO_EVENT_DEAD			1000
#define STUDIO_EVENT_NOINTERRUPT	1001
#define STUDIO_EVENT_CANINTERRUPT	1002
#define STUDIO_EVENT_FIREEVENT		1003
#define STUDIO_EVENT_SOUND			1004
#define STUDIO_EVENT_SENTENCE		1005
#define STUDIO_EVENT_INAIR			1006
#define STUDIO_EVENT_ENDANIMATION	1007
#define STUDIO_EVENT_SOUND_VOICE	1008
#define	STUDIO_EVENT_SENTENCE_RND1	1009
#define STUDIO_EVENT_NOT_DEAD		1010
...
#define BSP_LIGHTMAP_LUXELLEN    16
